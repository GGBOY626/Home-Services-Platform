...
export function OrderListPage() {
  ...
  useEffect(() => {
    if (!token) return;
    api<{ content: Order[] }>('/worker/orders?page=0&size=50', { token })
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-semibold text-neutral-900">My Assigned Orders</h1>
      {orders.length === 0 ? (
        <Card><CardContent className="py-12 text-center text-neutral-600">No orders assigned to you yet.</CardContent></Card>
      ) : (
